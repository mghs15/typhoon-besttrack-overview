...
let csv = "台風識別,日時,緯度,経度,中心気圧,最大風速,50kt長径方向,50kt長径,50kt短径,30kt長径方向,30kt長径,30kt短径,上陸,クラス" + "\n";
let tInfo = "";
...
text.split(/\n/).forEach( line => {
  ...
  if(c){
    csv += `${tInfo},${c[1]},${c[4]/10},${c[5]/10},${c[6]},${c[7]},${c[8]},${c[9]},${c[10]},${c[11]},${c[12]},${c[13]},${c[14]},${c[3]}` + "\n";
  }else{
    console.log(line);
  }
